    ...
    return (
      <Template>
        <div className="text-center">
          <h4 className="font-weight-bold">Register to get started.</h4>
          <h6 className="text-muted">Start sending money in less than 5 minutes</h6>
        </div>
        <form className="onboarding-form mx-auto mt-5" onSubmit={ this.onSubmit }>
          ...
          <ActionButton className="btn-success btn-sp btn-block font-weight-bold" type="submit" loading={ isLoading }>Register</ActionButton>
        </form>
      </Template>
    )
  }
